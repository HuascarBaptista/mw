...
function actualizarGaleria(){
  ...
  var deteccionMovimiento= $("#deteccionMovimiento").val();
 
   
    $.ajax({
        url: "ajax_galeria",
        data: {'from':tiempoInicio,'to':tiempoFin,camara:camara,deteccionMovimiento:deteccionMovimiento},
        type: "POST",
        success: function(data){
          $("#tabla").html(data);
        },
...
$(document).ready(function(){
  ...
  // http://docs.jquery.com/Plugins/Validation/validate#toptions
    ...
    $('#editarTemporal').validate({
      ...
      messages:{
        "valor":{
        required:"Introduzca el nuevo valor.",
        digits:"Sólo números."},
    ...
    $('#agregarCamara').validate({
      ...
      messages:{
        "ip":{
        required:"Introduzca la dirección IP.",
        maxlength:"Máximo 15 caracteres."},
        "puerto":{
        required:"Introduzca el número de puerto."},
        "usuario":{
  ...
  $(document).on("change","#deteccionMovimiento",function(){
    return  actualizarGaleria();
  });
